...
// cdm: changed mainmenuleft from 180 to 204
// cdm: changed mainmenu2left from 180 to 204
...
placeIt('Downtown',mainmenu2left + offset3,topOffset);
placeIt('Beaches',mainmenu2left +offset3+offset4,topOffset);
placeIt('Nassau',mainmenu2left +offset3+offset4+offset5,topOffset);
placeIt('South',mainmenu2left +offset3+offset4+offset5+offset6,topOffset);
placeIt('Wolfson',mainmenu2left +offset3+offset4+offset5+offset6+offset7,topOffset);
