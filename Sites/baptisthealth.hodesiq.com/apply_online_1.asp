	            ...
	            <p class="smalltextb">Last Name</font></p></td>
	                                  ...
	                                  <tr> 
	                                   ...
	                                   <td class="smalltextb">County</td>
	                                    <td colspan="3" class="smalltextb">City/Province</td>
	                                  </tr>
	                                  <tr> 
	                                    <td height="2%"><font size="-2"> 
	                                    ...
	                                    <td colspan="3"><font size="-2"> 
	                                      <input name="txtCity" id="City/Province" type="text" value="<%=strCity%>">
	                                      </font></td>
	                                  </tr>
	                                  <tr> 
	                                    <td height="1%" class="smalltextb">State</td>
	                                    <td class="smalltextb">Postal Code</td>
	                                    <td colspan="3"><p class="smalltextb">Home 
	                                        Phone</font></td>
	                                  </tr>
	                                  <tr> 
	                                    <td height="2%"><font size="-2"> 
																				<select name='selState' size='-2' ID='State'>
	                                    ...
	                                    <td><font size="-2"> 
	                                      <input name="txtZip" id="Postal_Code" type="text" value="<%=strZip%>">
	                                      </font></td>
	                                    ...
	                                    <td colspan="3"><font size="-2">&nbsp;</font></td>
																		...
																		<tr>
																			<td colspan=3 align=left>
																				<select name="media_info" id="Media_info">
	              ...
	              <input type="radio" name="radNameChange" value="Yes" id="Name_change">
	              Yes 
	              <input type="radio" name="radNameChange" value="No" id="Name_change">
	              No<br>
	              Former name(s): <br>
	...
	<p class='breakhere'></p>
	            ...
	            <p class="smalltext">Have you resided in another state within the 
	              last 7 years? </font> </td>
	                                    ...
	                                    <td width="17%" valign="top">
																				<select name="selState7Years_1" ID='State'>
																					<%=GetStateList("", False)%>
	                                      </select>
	                                    </td>
	                                  </tr>
	                                  <tr> 
	                                    ...
	                                    <td width="17%"><select name="selState7Years_2" ID='State'>
																					<%=GetStateList("", False)%>
	                                      </select></td>
	                                  </tr>
	                                  <tr> 
	                                    ...
	                                    <td width="17%">
																				<select name="selState7Years_3" ID='State'>
																					<%=GetStateList("", False)%>
		                                    </select></td>
	                                  </tr>
	                                  <tr> 
	      ...
	      <table bgcolor="<%=LONG_FORM_COLOR%>" width="100%" border="0" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
	        <tr> 
	                                  ...
	                                  <td height="6%" colspan="5" bgcolor="#003399"><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif"><strong>EMPLOYMENT 
	                                    HISTORY</strong></font></td>
	                                </tr>
	                                <tr> 
	                                  <td height="7%" colspan="5"> <p class="smalltext">Company </font>
	                                      <font size="-2"> 
	                                ...
	                                <tr> 
	                                  ...
	                                  <td width="0" height="11%" valign="top"> <p class="smalltext">City/Province<br></font>
	                                      <font size="-2"> 
	                                      <input type="text" name="txtEmpHistCity_1" id="Employer_city">
	                                      </font> </td>
	                                  <td width="0" valign="top"> <p class="smalltext">State</font><font size="-2"><br>
	                                      <select name="txtEmpHistState_1" size="1" id="State_one">
																					<%=GetStateList("", False)%>
	                                      </select>
	                                      </font></td>
	                                  <td width="0" valign="top"> <p class="smalltext">Postal Code</font><font size="-2"><br>
	                                      <input name="txtEmpHistZip_1" type="text" size="10" id="Postal_Code">
	                                      </font></td>
	                                  <td width="0" valign="top"> <p class="smalltext">Phone 
	                              ...
	                              <table bgcolor="<%=LONG_FORM_COLOR%>" width="100%" height="10" border="0" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
	                                ...
	                                <tr> 
	                                  <td height="8%" colspan="5"> <p class="smalltext">Company </font>
	                                      <font size="-2"> 
	                                ...
	                                <tr> 
	                                  ...
	                                  <td width="0" valign="top"> <p class="smalltext">State</font><font size="-2"><br>
	                                      <select name="txtEmpHistState_2" size="1" id="State_two">
																						<%=GetStateList("", False)%>
	                                      </select>
	                                      </font></td>
	                                  <td width="0" valign="top"> <p class="smalltext">Postal Code</font><font size="-2"> 
	                                      <br>
	                                      <input name="txtEmpHistZip_2" type="text" size="10" id="Postal_Code">
	                                      </font></td>
	                                  <td width="0" valign="top"> <p class="smalltext">Phone 
	                                      Number</font><font size="-2"><br>
	                              ...
	                              <table bgcolor="<%=LONG_FORM_COLOR%>" width="100%" height="10" border="0" cellpadding="1" cellspacing="1" bordercolor="#CCCCCC">
	                                ...
	                                <tr> 
	                                  ...
	                                  <td width="0" height="13%"> <p class="smalltext">City/Province<br>
	                                      <input type="text" name="txtEmpHistCity_3"></font> 
	                                  </td>
	                                  <td width="0" valign="top"> <p class="smalltext">State<br>
	                                      <select name="txtEmpHistState_3" size="1" id="State_three">
																					<%=GetStateList("", False)%>
	                                      </select></font>
	                                  </td>
	                                  <td width="0" valign="top"> <p class="smalltext">Postal Code 
	                                      <br>
	                                      <input name="txtEmpHistZip_3" type="text" size="10" id="Postal_Code"></font>
	                                  </td>
	                                  <td width="0"> <p class="smalltext">Phone 
	                                      Number<br>
		...
		function SubmitForm()
			{
				...
				for(iLoop=0; iLoop < arrTextFields.length; iLoop++)
						...
						if(CheckForSpaces(eval('document.frmLongApp.' + arrTextFields[iLoop] + '.value'))=='')
							{
								...
								if((strFieldID!='Social Security') && (strFieldID!='State') && (strFieldID!='County') && (strFieldID!='State one') && (strFieldID!='State two') && (strFieldID!='State three'))
									{
					...
					if (document.frmLongApp.media_info.value == '6951')
						{
							if (CheckForSpaces(document.frmLongApp.Other_Media.value)=='')
								{
									alert('Please let us know where you heard about this site.');
		 							document.frmLongApp.Other_Media.focus();
									return false;
								}
						}
					...
					if (document.frmLongApp.chkStillEmployeed.checked==false)
						{
							if (CheckForSpaces(document.frmLongApp.txtEmpHistLeaveReason_1.value)=='')
								{
									alert('Please state your reasons for leaving')
									document.frmLongApp.txtEmpHistLeaveReason_1.focus();
									return false;
								}
						}
						
					<%=Replace(strJavascript, ".frm.", ".frmLongApp.")%>
			}
